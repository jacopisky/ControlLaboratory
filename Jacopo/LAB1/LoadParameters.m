...
% state space
a22 = -1/simp_model.Tm;
b2  = simp_model.Km/gbox.N/simp_model.Tm;
c1  = 1;

state_space.plant.A = [0 1; 0 a22];
state_space.plant.B = [0;b2];
state_space.plant.C = [c1 0];
...
A    = [0, state_space.plant.C; [0;0], state_space.plant.A];
B    = [0; state_space.plant.B];
C    = [0, state_space.plant.C];
...
Az1   = [A1,[[0,0;0,0];state_space.plant.C];[[0,0,0;0,0,0],state_space.plant.A]];
Az2   = [A2,[[0,0;0,0];state_space.plant.C];[[0,0,0;0,0,0],state_space.plant.A]];
Az3   = [A3,[[0,0;0,0];state_space.plant.C];[[0,0,0;0,0,0],state_space.plant.A]];
Az4   = [A4,[[0,0;0,0];state_space.plant.C];[[0,0,0;0,0,0],state_space.plant.A]];
Bz    = [0;0;0;state_space.plant.B];
...
ees.Ae1   = [A1, [0 0; 0 0; 0 0];state_space.plant.B*ees.Croh, state_space.plant.A];
ees.Ae2   = [A2, [0 0; 0 0; 0 0];state_space.plant.B*ees.Croh, state_space.plant.A];
ees.Ae3   = [A3, [0 0; 0 0; 0 0];state_space.plant.B*ees.Croh, state_space.plant.A];
ees.Ae4   = [A4, [0 0; 0 0; 0 0];state_space.plant.B*ees.Croh, state_space.plant.A];
ees.Be = [0;0;0;state_space.plant.B];
ees.Ce = [0, 0, 0, state_space.plant.C];
...
ees.controller = place(state_space.plant.A, state_space.plant.B, pcs);
