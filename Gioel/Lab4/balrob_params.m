...
%% Non linear dynamical model (input: ua)

% M(q)*ddotq + C(q,dotq)*dotq + Fv1*dotq + g(q) = tau1

% M --> constant terms
nlmodel.M_11 = 2*wheel.Iyy + 2*gbox.N^2*mot.rot.Iyy + (body.m + 2*wheel.m + 2*mot.rot.m)*wheel.r^2;
nlmodel.M_22 = body.Iyy + 2*(1 - gbox.N)^2*mot.rot.Iyy + body.m*body.zb^2 + 2*mot.rot.m*(mot.rot.zb)^2;
...
% Fv1 --> constant terms
nlmodel.Fv1_11 = 2*(gbox.B + wheel.B) + 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
nlmodel.Fv1_12 = -2*gbox.B - 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
nlmodel.Fv1_21 = -2*gbox.B - 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
nlmodel.Fv1_22 = 2*gbox.B + 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
nlmodel.Fv1 = [nlmodel.Fv1_11 nlmodel.Fv1_12; nlmodel.Fv1_21 nlmodel.Fv1_22];

% g --> constant terms
nlmodel.g_1 = 0;

% ua --> tau1
nlmodel.ua2tau1 = 2*gbox.N*mot.Kt/mot.R*[1;-1];

%% linearized dynamical model (input: ua)

% M*ddotq + Fv1*dotq + G*q = tau1

% M --> constant terms
linmodel.M_11 = 2*wheel.Iyy + 2*gbox.N^2*mot.rot.Iyy + (body.m + 2*wheel.m + 2*mot.rot.m)*wheel.r^2;
linmodel.M_12 = 2*gbox.N*(1 - gbox.N)*mot.rot.Iyy + (body.m*body.zb + 2*mot.rot.m*mot.rot.zb)*wheel.r;
linmodel.M_21 = linmodel.M_12;
linmodel.M_22 = body.Iyy + 2*(1 - gbox.N)^2*mot.rot.Iyy + body.m*body.zb^2 + 2*mot.rot.m*(mot.rot.zb)^2;
linmodel.M = [linmodel.M_11 linmodel.M_12; linmodel.M_21 linmodel.M_22];

% C --> constant terms
linmodel.G_11 = 0;
linmodel.G_21 = 0;
linmodel.G_12 = 0;
linmodel.G_22 = -(body.m*body.zb + 2*mot.rot.m*mot.rot.zb)*g;
linmodel.G = [linmodel.G_11 linmodel.G_12; linmodel.G_21 linmodel.G_22];

% Fv1 --> constant terms
linmodel.Fv1_11 = 2*(gbox.B + wheel.B) + 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
linmodel.Fv1_12 = -2*gbox.B - 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
linmodel.Fv1_21 = -2*gbox.B - 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
linmodel.Fv1_22 = 2*gbox.B + 2*gbox.N^2*mot.Kt*mot.Ke/mot.R;
linmodel.Fv1 = [nlmodel.Fv1_11 nlmodel.Fv1_12; nlmodel.Fv1_21 nlmodel.Fv1_22];